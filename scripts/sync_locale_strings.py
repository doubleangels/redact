...
LOCALES = {
    "values-de": {
        "settings_permissions_subtitle": "Ab Android 13 funktioniert die System-Fotoauswahl ohne breiten Medienzugriff. Vollzugriff hilft Bereinigen und Konvertieren beim Lesen vorhandener Galerie-Dateien. Benachrichtigungen und Netzwerk sind optional.",
        ...
        "scan_status_ready": "Wählen Sie ein Foto oder Video, um dessen Metadaten zu scannen.",
    ...
    "values-es": {
        "settings_permissions_subtitle": "En Android 13+, el selector del sistema funciona sin acceso amplio a la biblioteca. El acceso completo ayuda a Limpiar y Convertir a leer archivos existentes. Notificaciones y red son opcionales.",
        ...
        "scan_status_ready": "Selecciona una foto o video para escanear sus metadatos.",
